...
public class TestPackage_figures {
  public static void main(String args[])
  {
	  ...
	  System.out.println("Enter the side side1 of Triangle :");
	  int s1=sc.nextInt();
	  System.out.println("Enter the side side2 od Triangle :");
	  int s2=sc.nextInt();
	  System.out.println("Enter the side side3 od Triangle :");
	  int s3=sc.nextInt();

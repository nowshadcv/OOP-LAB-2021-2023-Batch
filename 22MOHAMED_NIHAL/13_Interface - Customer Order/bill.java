...
class ProductB implements BillGen{
	String name;
	int prod_id,qty,unit_price,total;
	ProductB(){}
...
public class Bill {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++) {
			System.out.println("Enter the nos. of Products: ");
			int m =sc.nextInt();
		...
		for(int i=0;i<n;i++) {
			...
			System.out.println("-------------------------------------------------------------------------------------------");
			System.out.printf("%5s %20s %25s %15s %10s","Prod_Id","Name","Qty","Unit_Price","Total");
			System.out.println();
			System.out.println("---------------------------------------------------------------------");
			for(int j=0;j<order[i].length;j++) {
				System.out.printf("%5s %20s %25s %15s %10s",order[i][j].prod_id,order[i][j].name,order[i][j].qty,order[i][j].unit_price,order[i][j].total);
				System.out.println();}
			System.out.println("---------------------------------------------------------------------------------------------");
